...
const EditUserForm = ({ user }) => {
  ...
  const onUsernameChanged = (e) => { return setUsername(e.target.value); };
  const onPasswordChanged = (e) => { return setPassword(e.target.value); };
  ...
  const onActiveChanged = () => { return setActive((prev) => { return !prev; }); };
